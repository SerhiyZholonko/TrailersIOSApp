...
class PopuplarDetaillView: UIView {
    ...
    var delegate: PopuplarDetaillViewDelegate?
    ...
    //MARK: - init
    init(frame: CGRect, viewModel: PopularDetaillViewViewModel) {
    ...
    @objc private func didTapPlayButton() {
        delegate?.toVideoController(id: "\(viewModel.publicId)")
    }
...
extension PopuplarDetaillView: PopularDetaillViewViewModelDelegate {
...
extension PopuplarDetaillView: ReactionViewDalegate {
