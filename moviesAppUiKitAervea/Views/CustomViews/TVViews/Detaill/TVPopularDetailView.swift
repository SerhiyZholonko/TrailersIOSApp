...
class TVPopularDetailView: UIView {
    //MARK: - Properties
    weak var delegate: TVPopularDetailViewDelegate?
    ...
    //MARK: - init
    init(frame: CGRect, viewModel: TVPopopularDetailViewModel) {
   ...
   private func add(chaildVC: UIViewController, to containerView: UIView) {
    ...
    @objc private func didTappedPlayButton() {
        delegate?.toVideoControler(id: "\(viewModel.movieId)")
    }
    //TODO: -
}
...
extension TVPopularDetailView: ReactionViewDalegate {
